...
//		
		...
		List<String> valores = new ArrayList<String>(Arrays.asList("R$ 508","R$ 756","R$ 1.008","R$ 1.263"));
		
		Assert.assertTrue(resultado.tabelaResultadoTempo2(mesesValor, valores));
